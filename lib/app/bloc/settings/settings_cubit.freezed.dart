...
class _$SettingsStateTearOff {
  ...
  _SettingsState call({ThemeMode theme = ThemeMode.light}) {
...
class _$_SettingsState implements _SettingsState {
  const _$_SettingsState({this.theme = ThemeMode.light});
...
abstract class _SettingsState implements SettingsState {
  const factory _SettingsState({ThemeMode theme}) = _$_SettingsState;
