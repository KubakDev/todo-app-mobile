...
class _$HomeStateTearOff {
  ...
  _Initial initial(DateTime selectedDate) {
    return _Initial(
      selectedDate,
    );
  }
...
class _$_Initial implements _Initial {
  const _$_Initial(this.selectedDate);
  ...
  @override
  String toString() {
    return 'HomeState.initial(selectedDate: $selectedDate)';
  }
...
abstract class _Initial implements HomeState {
  const factory _Initial(DateTime selectedDate) = _$_Initial;
