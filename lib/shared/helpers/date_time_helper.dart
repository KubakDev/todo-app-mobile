...
extension DateTimeHelpers on DateTime {
  ...
  /// Returns a [String] which represents the date
  /// formatted by the given pattern.
  /// Patterns can be found
  /// [here](https://api.flutter.dev/flutter/intl/DateFormat-class.html)
  /// (intl documentation).
  ///
  ...
  /// Whether the date is on the same day
  /// (regardless of the time) as the given date.
