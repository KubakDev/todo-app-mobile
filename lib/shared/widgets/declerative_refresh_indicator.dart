/// Code from declarative_refresh_indicator package from pub.dev
...
class DeclarativeRefreshIndicatorState
  ...
  /// When the [_completer] is not in use by the indicator, it must be `null`.
  ...
  Future<void> _onRefresh() async {
    ...
    // called again.
    assert(_completer == null, 'The completer should not exist at this point.');
